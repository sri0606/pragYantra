    ...
    while True:
        try:
            ...
            if not data_queue.empty():
                ...
                # If the timer has expired, save the transcriptions to a JSON file
                if now >= next_save_time:
                    # Format the date as a string in the format YearMonthDay
                    ...
                    # If the current hour is not in the existing data, add it
                    if current_hour not in existing_data:
                        existing_data[current_hour] = []

                    # Append the new transcriptions to the existing data
                    ...
                    # Clear the transcriptions for the current hour
                ...
                for line,val in transcriptions.items():
                    print(line, ": ",val)
                # Flush stdout.
